		...
		<div class="row mtop10">
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<select id="month" name="month" class="combos"> 
							<option value=""></option>
							<?php foreach($months as $item){?>
								<option <?php if($montNow == $item->monthyear){?> selected <?php }?> value="<?=$item->id;?>"><?=$item->monthyear;?></option>
							<?php }?>
						</select>
					</div>
				</div>
...
<div class="loading" style="display: none;">
	...
	<div class="blockUI blockMsg blockElement" style="width: 30%;position: absolute;top: 15%;left:35%;text-align: center;">
		<img src="<?=url_tmpl()?>img/preloader.gif" style="z-index: 29999;position: absolute;"/>
	</div>
</div> 
<!-- ui-dialog -->
<!--S Modal -->
